...
const MUSCLE_MAP = {
  ...
  "Trap Bar Shrug": { primary: ["traps"], secondary: [] },
  "Smith Machine Shrug": { primary: ["traps"], secondary: [] },
  "Cable Shrug": { primary: ["traps"], secondary: [] },
  "Behind-the-Back Barbell Shrug": { primary: ["traps"], secondary: [] },
  "Snatch-Grip Shrug": { primary: ["traps"], secondary: ["forearm"] },
  "Cable Upright Row": { primary: ["sideDelt"], secondary: ["traps", "biceps"] },
  "DB Upright Row": { primary: ["sideDelt"], secondary: ["traps", "biceps"] },
  "Y-Raise": { primary: ["traps"], secondary: ["rearDelt"] },
  "Farmer's Carry": { primary: ["traps"], secondary: ["forearm"] },
